...
public class ItemESP extends Module {
        ...
        for (Entity ent : mc.world.getEntities()) {
            ...
            if (position != null) {
                ...
                if (espMode.getValue() == ESPMode.Rect)
                    drawRect(context.getMatrices(), posX, posY, endPosX, endPosY);
    ...
    private void drawRect(MatrixStack stack, float posX, float posY, float endPosX, float endPosY) {
        Color black = Color.BLACK;

        Render2DEngine.drawRectDumbWay(stack, posX - 1F, posY, (posX + 0.5f), endPosY + 0.5f, black, black, black, black);
        Render2DEngine.drawRectDumbWay(stack, posX - 1F, (posY - 0.5f), endPosX + 0.5f, posY + 1f, black, black, black, black);
        Render2DEngine.drawRectDumbWay(stack, endPosX - 1f, posY, endPosX + 0.5f, endPosY + 0.5f, black, black, black, black);
        Render2DEngine.drawRectDumbWay(stack, posX - 1, endPosY - 1f, endPosX + 0.5f, endPosY + 0.5f, black, black, black, black);

        Render2DEngine.drawRectDumbWay(stack, posX - 0.5f, posY, posX, endPosY, HudEditor.getColor(270), HudEditor.getColor(0), HudEditor.getColor(0), HudEditor.getColor(270));
        Render2DEngine.drawRectDumbWay(stack, posX, endPosY - 0.5f, endPosX, endPosY, HudEditor.getColor(0), HudEditor.getColor(180), HudEditor.getColor(180), HudEditor.getColor(0));
        Render2DEngine.drawRectDumbWay(stack, posX - 0.5f, posY, endPosX, (posY + 0.5f), HudEditor.getColor(180), HudEditor.getColor(90), HudEditor.getColor(90), HudEditor.getColor(180));
        Render2DEngine.drawRectDumbWay(stack, endPosX - 0.5f, posY, endPosX, endPosY, HudEditor.getColor(90), HudEditor.getColor(270), HudEditor.getColor(270), HudEditor.getColor(90));

    ...
    public class Particle {
        ...
        public void render(MatrixStack matrixStack) {
            ...
            switch (mode.getValue()) {
                case Orbiz -> {
                    Render2DEngine.drawOrbiz(matrixStack, 0.0f, 0.7, color);
                    Render2DEngine.drawOrbiz(matrixStack, 0.1f, 1.4, color);
                    Render2DEngine.drawOrbiz(matrixStack, 0.2f, 2.3, color);
                }
                case Stars -> Render2DEngine.drawStar(matrixStack, color, starsScale.getValue());
                case Hearts -> Render2DEngine.drawHeart(matrixStack, color, starsScale.getValue());
            }

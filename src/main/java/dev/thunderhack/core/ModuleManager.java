...
import dev.thunderhack.gui.hud.impl.*;
import dev.thunderhack.modules.Module;
import dev.thunderhack.modules.client.*;
import dev.thunderhack.modules.combat.*;
import dev.thunderhack.modules.misc.*;
import dev.thunderhack.modules.movement.*;
import dev.thunderhack.modules.movement.Timer;
import dev.thunderhack.modules.player.*;
import dev.thunderhack.modules.render.*;

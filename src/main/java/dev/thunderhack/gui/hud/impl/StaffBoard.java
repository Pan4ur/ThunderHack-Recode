...
import dev.thunderhack.cmd.impl.StaffCommand;
...
public class StaffBoard extends HudElement {
    ...
    public static List<String> getOnlinePlayer() {
        return Module.mc.player.networkHandler.getPlayerList().stream()
    ...
    public static List<String> getOnlinePlayerD() {
        ...
        for (PlayerListEntry player : Module.mc.player.networkHandler.getPlayerList()) {
            if (Module.mc.isInSingleplayer() || player.getScoreboardTeam() == null) break;
    ...
    public List<String> getVanish() {
        ...
        for (Team s : Module.mc.world.getScoreboard().getTeams()) {
            if (s.getPrefix().getString().length() == 0 || Module.mc.isInSingleplayer()) continue;
    ...
    public static boolean check(String name) {
        if (Module.mc.getCurrentServerEntry() != null && Module.mc.getCurrentServerEntry().address.contains("mcfunny")) {

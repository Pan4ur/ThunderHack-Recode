...
public class TargetHud extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        } else if (Module.mc.currentScreen instanceof ChatScreen || Module.mc.currentScreen instanceof HudEditorGui) {
            target = Module.mc.player;
            direction = true;
        } else {
            direction = false;
        ...
        if (animation.getAnimationd() > 0) {
            ...
            if (Mode.getValue() == ModeEn.ThunderHack) {
                ...
                if (target instanceof PlayerEntity) {
                    ...
                    RenderSystem.setShaderTexture(0, Module.mc.getEntityRenderDispatcher().getRenderer(target).getTexture(target));
                }
                RenderSystem.enableBlend();
                ...
                if (target instanceof PlayerEntity) {
                    ...
                    for (ItemStack itemStack : items) {
                        ...
                        context.drawItemInSlot(Module.mc.textRenderer, itemStack, 0, 0);
                ...
                if (target instanceof PlayerEntity) {
                    if (!((PlayerEntity) target).getInventory().armor.get(3).isEmpty()) {
                        ...
                        context.drawItemInSlot(Module.mc.textRenderer, ((PlayerEntity) target).getInventory().armor.get(3), 0, 0);
                        context.getMatrices().pop();
                    }
                    ...
                    if (!((PlayerEntity) target).getInventory().armor.get(2).isEmpty()) {
                        ...
                        context.drawItemInSlot(Module.mc.textRenderer, ((PlayerEntity) target).getInventory().armor.get(2), 0, 0);
                        context.getMatrices().pop();
                    }
                    ...
                    if (!((PlayerEntity) target).getInventory().armor.get(1).isEmpty()) {
                        ...
                        context.drawItemInSlot(Module.mc.textRenderer, ((PlayerEntity) target).getInventory().armor.get(1), 0, 0);
                        context.getMatrices().pop();
                    }
                    ...
                    if (!((PlayerEntity) target).getInventory().armor.get(0).isEmpty()) {
                        ...
                        context.drawItemInSlot(Module.mc.textRenderer, ((PlayerEntity) target).getInventory().armor.get(0), 0, 0);
                        context.getMatrices().pop();
                    }

    ...
    public void onRender3D(MatrixStack stack) {
        ...
        try {
            for (BlockPos pos : ores) {
                ...
                if (block == Blocks.DIAMOND_ORE && diamond.getValue()) draw(pos, 0, 255, 255);
                if (block == Blocks.GOLD_ORE && gold.getValue()) draw(pos, 255, 215, 0);
                ...
                if (block == Blocks.REDSTONE_ORE && redstone.getValue()) draw(pos, 255, 0, 0);

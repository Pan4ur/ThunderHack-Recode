...
public class Companion extends HudElement {
    ...
    public final Identifier BALTIKA = Identifier.of("thunderhack", "textures/hud/elements/baltika.png");
    private final Identifier KOWK = Identifier.of("thunderhack", "textures/hud/elements/kowk.png"); // kowk!!!1

...
public class TimerIndicator extends HudElement {
    ...
    public void onRender2D(Render2DEvent e) {
        ...
        Render2DEngine.drawRound(e.getMatrixStack(),getPosX(), getPosY(), 62, 12, HudEditor.hudRound.getValue() - 3f, new Color(1));
        Render2DEngine.renderRoundedGradientRect( e.getMatrixStack(),HudEditor.getColor(270), HudEditor.getColor(0), HudEditor.getColor(180),  HudEditor.getColor(90),getPosX() + 0.5f, getPosY() + 0.5f, (int) timerStatus, 11, HudEditor.hudRound.getValue() - 3f);
